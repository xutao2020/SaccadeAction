...
class opts(object):
    def __init__(self):
        ...
        self.parser.add_argument('--final_wh_weight', type=float, default=0.1,
                                 help='loss weight for final bbox regression.')
        self.parser.add_argument('--cor_att_weight', type=float, default=4,
                                 help='loss weight for corner heatmaps.')
